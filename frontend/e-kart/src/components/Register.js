                ...
                <form>
                    ...
                    <div className="container">
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-12 col-md-6">
                                <textarea class="form-control" rows="5" id="comment">Company Address</textarea>
                            </div>
                            <div class="form-group col-lg-12 col-md-6">

                                <input type="text" class="form-control form-control-sm" id="inputEmail4" placeholder="location" />
                            </div>
                            <div class="form-group col-lg-12 col-md-6">
