...
export default class AddProducts extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			progress: "",
			models: [
				{ brand: "Apple", model: "Iphone 8plus" },
				{ brand: "Apple", model: "Iphone 7plus" },
				{ brand: "Samsung", model: "Samsung Galaxy A20" },
				{ brand: "Samsung", model: "Samsung Galaxy A70" },
				{ brand: "Oppo", model: "Oppo F5" },
				{ brand: "Oppo", model: "Oppo Reno2" },
				{ brand: "Redmi", model: "Redmi K20 Pro" },
				{ brand: "Redmi", model: "Redmi Note7 Pro" },
				{ brand: "OnePlus", model: "OnePlus 7" },
				{ brand: "OnePlus", model: "OnePlus 6" },
				{ brand: "Vivo", model: "Vivo Z1 X" },
				{ brand: "Vivo", model: "Vivi Z1 Pro" },
				{ brand: "LG", model: "LG G2" },
				{ brand: "LG", model: "LG G1" },
				{ brand: "Nokia", model: "Nokia 9" },
				{ brand: "Nokia", model: "Nokia 8" }
			]
		};
	}
	...
	brand = e => {
		let model = this.state.models.filter(item => {
	...
	submit = () => {
        let token = getTokenFromCookie("vendor")
        console.log(token)
				...
				<div className='container-fluid design1'>
					<div className='card container design2' style={{ width: "800px" }}>
						<form>
							...
							<div className='row'>
								<div className='col-lg-6'>
									<div class='form-group '>
										...
										{this.state.model_name.length != 0 ? (
											<select
												class='form-control form-control-lg'
												onChange={e => this.setState({ model_name: e.target.value })}
											>
												<option value=''>Select</option>
												<option value={this.state.model_name[0].model}>
													{this.state.model_name[0].model}
												</option>
												<option value={this.state.model_name[1].model}>
													{this.state.model_name[1].model}
												</option>
											</select>
										) : (
                            ...
                            <div class='form-group '>
								<label for='formGroupExampleInput2'>Offer percentage:</label>
								<input
									type='number'
									class='form-control'
									id='formGroupExampleInput2'
									placeholder='Price'
									onChange={e => this.setState({ offer_price: e.target.value })}
